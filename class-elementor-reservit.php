...
/**
 * Main Elementor reservit Class
 *
 * The init class that runs the Elementor reservit plugin.
 ...
 */
final class Elementor_reservit
{
	...
	{
		load_plugin_textdomain('elementor-reservit');
	}
	...
	{
		deactivate_plugins(plugin_basename(ELEMENTOR_RESERVIT));
...
// Instantiate Elementor_reservit.
new Elementor_reservit();
